  ...
  return (
    <footer>
      <div className="container">
        ...
        <ul>
          <li>
            <a href="https://www.facebook.com/economiarioiv" target="_blank" rel="noreferrer noopener">
              <i className="fab fa-lg fa-facebook "></i>
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/economiariocuarto/" target="_blank" rel="noreferrer noopener">
              <i className="fab fa-lg fa-instagram "></i>
            </a>
          </li>
          <li>
            <a href="https://twitter.com/pabloantonetti" target="_blank" rel="noreferrer noopener">
